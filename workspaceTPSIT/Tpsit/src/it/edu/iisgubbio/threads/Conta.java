...
/**
 * Lanciare due thread uno che srive 
 * i numeri da 1 a 10 e l'altro che 
 * scrive i numeri da 50 a 100
 * 
 * Dato che abbiamo realizzato un'unica 
 * classe che implementa un thread, per
 ...
 * impartito dalla VM e stampano tutti i numeri 
 * prima di passare al secondo thread
 */
